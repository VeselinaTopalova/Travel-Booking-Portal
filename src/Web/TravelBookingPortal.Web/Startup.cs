namespace TravelBookingPortal.Web
{
                ...
                endpoints =>
                    {
                        endpoints.MapControllerRoute(
                            "company",
                            "{name:minlength(3)}",
                            new { controller = "Company", action = "ByName" });
